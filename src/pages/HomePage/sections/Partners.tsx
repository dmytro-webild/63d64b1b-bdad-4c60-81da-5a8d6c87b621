    ...
    <section aria-label="Social proof section" className="py-20">
      <div className="flex flex-col gap-8 md:gap-10">
        <div className="flex flex-col items-center gap-2 w-content-width mx-auto">
          ...
          <TextAnimation
            text={"We are proud to partner with leading logistics companies to drive excellence."}
            variant={"fade"}
            gradientText={false}
            tag="p"
...
export default function PartnersSection() {
  return (
    <div data-webild-section="partners" data-section="partners" id="partners">
      <PartnersInline />
    </div>
  );
}
